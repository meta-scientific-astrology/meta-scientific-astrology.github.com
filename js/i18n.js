(function () {
  ...
  var translations = {
    en: {
      ...
      'app.hero.subtitle': 'Discover your archetype, decode relationship dynamics, and track personal cycles with precision algorithms.',
      ...
      'app.section.compatibility.deep.text': 'Dive into the <strong>Relationship Architecture</strong> - Soul Resonance, Couple Attraction, Emotional Safety, Chemistry, and more. Identify <strong>Vulnerabilities</strong> like Love Asymmetry, Drive, Friction points before they become real problems.',
      ...
      'app.section.compatibility.tags.tens': 'Drive Analysis',
      ...
      'app.section.radar.flow.title': 'Focus & Drive Map',
      'app.section.radar.flow.text': 'ALFI\'s Radar tracks the real-time energy landscape - detecting windows of <strong>Focus</strong>, <strong>Risks</strong>, and <strong>Drive</strong>. See your active window, danger level, and hourly timeline so you can time your actions with precision.',
      'app.section.radar.tags.flow': 'Focus States',
      'app.section.radar.tags.tens': 'Drive Windows',
      ...
      'app.section.pricing.basic.feature2': 'Monthly Forecast',
      'app.section.pricing.basic.feature3': '2 Bond Analyses',
      'app.section.pricing.basic.feature4': 'Advanced astro-algorithms',
      'app.section.pricing.basic.feature5': 'Support the Author',
      ...
      'app.section.pricing.premium.feature2': 'Unlimited forecasts',
      'app.section.pricing.premium.feature3': 'Unlimited Bond Analyses',
      'app.section.pricing.premium.feature4': 'Advanced astro-algorithms',
      'app.section.pricing.premium.feature5': 'Support the Author',
      ...
      'app.section.processor.label': 'Astro-Processor',
      'app.section.processor.title': 'Built for Real Chart Work',
      'app.section.processor.subtitle': 'ALFI is not just an interpretation tool. It includes a full calculation module designed for real chart analysis.',
      'app.section.processor.text1': 'The processor supports synastry, synchronization, resonance, and chart-based work out of the box — with a visual interface designed for fast navigation and deep reading.',
      'app.section.processor.text2': 'If you already understand astrology and know how to read charts, ALFI can be used as a full working module — not only as a guided app, but as a real calculation environment.',
      'app.section.processor.tags.synastry': 'Synastry Processor',
      'app.section.processor.tags.sync': 'Sync & Resonance',
      'app.section.processor.tags.theme': 'Dark & Light Themes',
      'app.section.processor.tags.manual': 'Manual Chart Reading',
      ...
      /* --- Paths --- */
      'path.theory': 'theory_msa/chapter_1.html'
    },
    ru: {
      /* --- Index Page --- */
      ...
      'app.hero.subtitle': 'Узнайте свой архетип, расшифруйте динамику отношений и отслеживайте персональные циклы с помощью точных алгоритмов.',
      ...
      'app.section.radar.flow.title': 'Карта фокуса и динамики',
      'app.section.radar.flow.text': 'Радар ALFI отслеживает энергетический ландшафт в реальном времени, выявляя окна <strong>Фокуса</strong>, <strong>Драйва</strong> и <strong>Рисков</strong>. Видьте активное окно, уровень опасности и почасовую шкалу, чтобы планировать действия с ювелирной точностью.',
      'app.section.radar.tags.flow': 'Состояния потока',
      'app.section.radar.tags.tens': 'Окна динамики',
      ...
      'app.section.pricing.basic.feature2': 'Прогноз на месяц',
      'app.section.pricing.basic.feature3': '2 анализа синастрии',
      'app.section.pricing.basic.feature4': 'Продвинутые астро-алгоритмы',
      'app.section.pricing.basic.feature5': 'Поддержка автора',
      ...
      'app.section.pricing.premium.feature2': 'Прогноз - на любую дату',
      'app.section.pricing.premium.feature3': 'Неограниченный анализ синастрий',
      'app.section.pricing.premium.feature4': 'Продвинутые астро-алгоритмы',
      'app.section.pricing.premium.feature5': 'Поддержка автора',
      ...
      'start.path.theory.text': 'Прочтите 9 глав, охватывающих философский и технический фундамент MSA. Прото-реальность, Резонанс, Солнечный Зодиак, Синастрия и многое другое.',
      ...
      'app.section.processor.label': 'Астропроцессор',
      'app.section.processor.title': 'Полноценный модуль для работы с картами',
      'app.section.processor.subtitle': 'ALFI — это не только интерпретационный инструмент. В приложении есть полноценный расчетный модуль для реальной работы с картами.',
      'app.section.processor.text1': 'Процессор из коробки поддерживает синастрию, синхронизацию, резонанс и полноценную работу с астрологическими картами — в визуальном интерфейсе, созданном для быстрого чтения и глубокого анализа.',
      'app.section.processor.text2': 'Если вы уже разбираетесь в астрологии и умеете читать карты, ALFI можно использовать не только как приложение с готовыми выводами, но и как полноценную расчетную среду.',
      'app.section.processor.tags.synastry': 'Синастрический процессор',
      'app.section.processor.tags.sync': 'Синхронизация и резонанс',
      'app.section.processor.tags.theme': 'Тёмная и светлая темы',
      'app.section.processor.tags.manual': 'Ручное чтение карт',

      /* --- Paths --- */
      'path.theory': 'theory_msa/ru/chapter_1.html'
    }
  };
